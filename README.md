...
| [搜索词管理器](./search-keyword-manager/) | 所有含搜索框的网站 | 个人搜索词管理，点击复制，按使用次数排序，支持导入/导出 | [安装](https://raw.githubusercontent.com/zwy/userscripts/main/search-keyword-manager/search-keyword-manager.user.js) |
